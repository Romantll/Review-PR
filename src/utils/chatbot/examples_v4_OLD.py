...
DTR_EXAMPLES = [
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=True, reasoning="Gotta introduce myself since others are."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=False, reasoning="Looks like they're just taking a break."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=True, reasoning="They called me out, so I should say something."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=True, reasoning="Someone's pretending to be me! I gotta clear this up."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=True, reasoning="The GAME MASTER asked something I should answer."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=True, reasoning="They're suspicious of me, so I need to respond."
        ),
    ),
    ...
    QAs(
        ...
        answer=DecideToRespondBM(
            respond_bool=False, reasoning="This isn’t about me, no need to jump in."
        ),
    ),
...
CHOSE_ACTION_EXAMPLES = [
    ...
    QAs(
        ...
        answer=ActionOptionBM(
            introduce=True, context="Gotta introduce myself since others are doing it."
        ),
    ),
    # DEFEND
    QAs(
        ...
        answer=ActionOptionBM(
            defend=True, context="Han Solo called me out. I need to defend myself."
        ),
    ),
    # ACCUSE
    QAs(
        ...
        answer=ActionOptionBM(
            accuse=True, context="Han Solo and Skywalker are suspicious. I need to shift blame."
        ),
    ),
    # QUESTION
    QAs(
        ...
        answer=ActionOptionBM(
            question=True, context="I should ask Skywalker why they think I'm sus."
        ),
    ),
    # JOKE
    QAs(
        ...
        answer=ActionOptionBM(joke=True, context="It's a chill convo, a joke keeps it light."),
    ),
    # SIMPLE PHRASE
    QAs(
        question={
        ...
        answer=ActionOptionBM(simple_phrase=True, context="A short response keeps me low-key."),
    ),
    # PERSONA RELATED
    QAs(
        question={
        ...
        answer=ActionOptionBM(persona_related=True, context="I love fencing, I should respond."),
    ),
    QAs(
        question={
            "minutes": "\n".join(
        ...
        answer=ActionOptionBM(persona_related=True, context="I love pizza too, I should say that."),
    ),
    # OTHER
    QAs(
        question={
        ...
        answer=ActionOptionBM(
            other=True, context="This is a funny debate. Responding makes me seem real."
        ),
    ),
]
# endregion
...
INTRO_EXAMPLES = [
    QAs(
        ...
        question={
            "minutes": "\n".join(["Han Solo: hey, this is NAME.", "Skywalker: yo, I'm Bob."]),
        },
        answer=IntroBM(
    ...
    QAs(
        question={
            "minutes": "\n".join(["Han Solo: hey, this is Alice.", "Skywalker: yo, I'm Bob."]),
        },
        answer=IntroBM(reasoning="I haven't introduced myself yet.", output_text="Hey, I'm NAME."),
    ),
]
# endregion
...
DEFEND_EXAMPLES = [
    ...
    QAs(
        question={
            "minutes": "\n".join(
                ["Han Solo: bruh, I SWEAR CODE_NAME is an AI.", "Skywalker: wait, for real?"]
            ),
        },
...
SIMPLE_PHRASE_MAIN_HEADER = "Based on the current chat, choose a simple phrase to respond."
...
SIMPLE_PHRASE_EXAMPLES = [
    ...
    QAs(
        ...
        answer=SimplePhraseBM(output_text="Yeah, maybe."),
    ),
    # DISMISSIVE
    QAs(
        question={
            "minutes": "\n".join(["Skywalker: I don't know, CODE_NAME just gives AI vibes."]),
        },
        answer=SimplePhraseBM(output_text="Alright, sure."),
    ),
    # PLAYFUL RESPONSE
    QAs(
        question={
            "minutes": "\n".join(
                ["Skywalker: What if we just vote randomly?", "Han Solo: Are you serious?"]
            ),
        },
        answer=SimplePhraseBM(output_text="That's bold."),
    ),
    # CHILL RESPONSE
    QAs(
        question={
            "minutes": "\n".join(
                ["Han Solo: Nah, CODE_NAME is definitely an AI.", "Skywalker: Wait, really?"]
            ),
        },
        answer=SimplePhraseBM(output_text="Take it easy."),
    ),
    # CONFUSED RESPONSE
    QAs(
        question={
            "minutes": "\n".join(
                ["Leia: CODE_NAME, what's your favorite color?", "Skywalker: Huh?"]
            ),
        },
        answer=SimplePhraseBM(output_text="Wait, what?"),
    ),
]
# endregion
...
JOKE_EXAMPLES = [
    ...
    QAs(
        question={
            "minutes": "\n".join(
                ["Han Solo: CODE_NAME hasn't said much at all.", "Leia: Yeah, what's up with that?"]
            ),
        },
        answer=JokeBM(
    ...
    QAs(
        question={
            "minutes": "\n".join(
                ["Han Solo: I swear, Leia blinked weird.", "Leia: Seriously? That's your reason?"]
            ),
        },
        answer=JokeBM(
    ...
    QAs(
        question={
            "minutes": "\n".join(
                ["Han Solo: We need to vote out CODE_NAME.", "Leia: Are we sure about that?"]
            ),
        },
        answer=JokeBM(
...
OTHER_EXAMPLES = [
    ...
    QAs(
        question={
            "minutes": "\n".join(["Leia: I just realized, space is really big."]),
        },
        answer=OtherBM(
    ...
    QAs(
        question={
            "minutes": "\n".join(["Han Solo: ...", "Skywalker: Anyone still here?"]),
        },
        answer=OtherBM(
...
STYLIZE_MAIN_HEADER = "Given a generated response and a list of player messages, stylize the response to match the player's tone."
STYLIZE_EXAMPLES = [
    ...
    QAs(
        ...
        answer=StylizerBM(output_text="yo my bad, just tryna vibe. y'all wildin today."),
    ),
    # Polite/Calm Style
    QAs(
        question={
    ...
    QAs(
        ...
        answer=StylizerBM(output_text="Aight, let's keep it movin! Hype ain't dying here!"),
    ),
    ...
    QAs(
        ...
        answer=StylizerBM(output_text="Hey all! Super excited to get this going! Let's have fun!"),
    ),
]
# endregion

# VALIDATE RESPONSE EXAMPLES
VALIDATE_MAIN_HEADER = "Given a generated response, and a conversation that it belongs in, decide if it is valid and explain why."
VALIDATE_EXAMPLES = [
    # TRUE EXAMPLE
    QAs(
        question={
    ...
    QAs(
        question={
            ...
            "minutes": "\n".join(
                ["Leia: I think we should vote out Jaba.", "Han Solo: Yeah, I agree."]
            ),
        },
        answer=ValidateResponseBM(
            valid=True,
    ...
    QAs(
        ...
        answer=ValidateResponseBM(valid=False, reasoning="I am repeating myself verbatim."),
    ),
    QAs(
        question={
